...
public interface IPost {
     ...
     * e un timestamp che rappresenta data e ora della pubblicazione<br>
     * TE: <id,author,text,timestamp> dove author,text sono scritti dall utente e passati come parametro al costruttore,<br>
